...
// LR2OSBD.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLR2OSBDApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CLR2OSBDApp::OnAppAbout)
...
// Создание CLR2OSBDApp

CLR2OSBDApp::CLR2OSBDApp() noexcept
{
	...
	SetAppID(_T("LR2OSBD.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CLR2OSBDApp

CLR2OSBDApp theApp;


// Инициализация CLR2OSBDApp

BOOL CLR2OSBDApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CLR2OSBDDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CLR2OSBDView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CLR2OSBDApp
